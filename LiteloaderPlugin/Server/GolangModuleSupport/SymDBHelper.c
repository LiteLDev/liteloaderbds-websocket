...
#ifndef LLWS_MEMDLL_NAME
#define LLWS_MEMDLL_NAME "llws_golang.dll"
#endif // !LLWS_MEMDLL_NAME
...
EXTERN_C_SymDBHelper void* (*getProcAddrWrapper)(void* hModule, LPCSTR lpProcName) = 0;
EXTERN_C_SymDBHelper void* subModuleHandler = 0;

EXTERN_C_SymDBHelper void LoadMemDLL();
